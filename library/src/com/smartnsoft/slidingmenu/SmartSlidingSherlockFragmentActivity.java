 ...
 * @since 2013.02.06
 */
public abstract class SmartSlidingSherlockFragmentActivity<AggregateClass>
    extends SlidingSherlockFragmentActivity
    implements SmartableActivity<AggregateClass>
{
  ...
  public void onCreate(final Bundle savedInstanceState)
  {
    droid4mizer.onCreate(new Runnable()
    {
      public void run()
      {
        SmartSlidingSherlockFragmentActivity.super.onCreate(savedInstanceState);
      }
    }, savedInstanceState);
  }
