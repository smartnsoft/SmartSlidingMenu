 ...
 * @since 2012.10.29
 */
public abstract class SmartSlidingSherlockActivity<AggregateClass>
    extends SlidingSherlockActivity
    implements SmartableActivity<AggregateClass>
{
  ...
  public void onCreate(final Bundle savedInstanceState)
  {
    droid4mizer.onCreate(new Runnable()
    {
      public void run()
      {
        SmartSlidingSherlockActivity.super.onCreate(savedInstanceState);
      }
    }, savedInstanceState);
  }
